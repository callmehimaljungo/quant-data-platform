...
2. ➡️ **Silver Layer:** Data cleaning and enrichment

   ```bash
   python silver/clean.py
   ```

3. ➡️ **Gold Layer:** Strategy calculations

   ```bash
   python gold/run_all_strategies.py
   ```

4. ➡️ **Dashboard:** Interactive visualization
...
# Run with coverage
pytest tests/ --cov=bronze --cov=silver --cov=gold
...
2. Verify R2/Kaggle credentials
